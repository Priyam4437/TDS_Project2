...
Original file is located at
    https://colab.research.google.com/drive/1cSuv3Eqsc_wlpy5RTUDEJZO8b5TMZeh2
"""
...
def call_api_with_retry(api_call, max_retries=5, delay=10):
...
# Ensure token is manually retrieved
def get_token():
    # Manually input your AIPROXY_TOKEN here
    token = "eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6IjIzZjIwMDM0MTJAZHMuc3R1ZHkuaWl0bS5hYy5pbiJ9.OCh8QtN72_eonLcubKlok5Yie6awds9upCo8cQ4UE4U"  # Replace with your token
    if token == "YOUR_AIPROXY_TOKEN":
...
def main():
    ...
    narrative = generate_narrative(analysis, token, Path(file_path))
